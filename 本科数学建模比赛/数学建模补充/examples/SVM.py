...
class SVMClassifier:
    def __init__(self, norm_type="Normalization", C=200, kernel="rbf", threshold=10e-3, g=0.1, c=0, n=3, max_iteration=100):
        ...
        self.g = g                                    # sigma_x for rbf, sigmoid poly
    ...
    '''
       ...
       Description: select the second parameters by elicitation method in inner loop 
       Input: i           dataType: int         description: the index of the first parameters 
              Ei          dataType: float       description: the error of the first parameters
       Output: j          dataType: int         description: the index of the second parameters
               Ej         dataType: float       description: the error of the second parameters 
    ...
    def selectAplha2(self, i, Ei):
        ...
        self.errors[i] = [1, Ei]
        valid_errors_index = np.nonzero(self.errors[:, 0])[0]     # get the nonzero value of the parameters
    ...
    '''
       ...
       Input: k           dataType: int         description: the index of the first parameters 
       '''
