...
class FPgrowth:
    ...
    '''
      ...
      Description: update header, add tail_node to the current last sink of frequent_item
      Input:  head_node           dataType: FPNode     description: first sink in header
              tail_node           dataType: FPNode     description: sink need to be added
    '''
    ...
    def createFPTree(self, train_data):
        ...
        FP_tree = FPNode('root', 1, None)        # root sink
    ...
    '''
      Function: ascendTree
      Description: ascend tree from leaf sink to root sink according to path
      Input:  sink           dataType: FPNode     description: leaf sink
