...
class KMeans:
    ...
    def biKmeans(self, train_data):
        ...
        while len(centers) < self.k:
            # print(len(centers))
            min_SSE  = np.inf
            best_index = None                                                   # index of cluster for best_value split
            best_centers = None                                                 # best_value the cluster center
            best_distances = None                                                # the distance between samples and cluster center

            # find the best_value split
            for j in range(len(centers)):
                ...
                # save the best_value split result
                if (split_SSE + other_SSE) < min_SSE:
                    best_index = j                                               # the best_value split index
                    best_centers = split_centers                                 # best_value cluster centers
