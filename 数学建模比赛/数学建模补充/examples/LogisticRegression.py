...
class LogisticRegressionClassifier:
    ...
    '''
       ...
       Input: parameters       dataType: float     description: original parameters
              method      dataTpye: int       description: update method of parameters
       Output: output     dataType: float     description: output
       '''
    ...
    '''
       ...
       Input:  train_data       dataType: ndarray   description: features
               ...
               parameters            dataType: float     description: the stride of the target
