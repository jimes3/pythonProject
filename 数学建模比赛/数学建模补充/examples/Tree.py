...
class DecisionTree:
    ...
    Output: self.tree_node  dataType: ndarray   description:  classification tree sink
    '''
...
class RegressionTree:
    ...
    def createRegressionTree(self, data):
        ...
        # get the best_value split feature and value
    ...
    def pruning(self, tree, val_data):
        ...
        # if there only exist two leaves sink
