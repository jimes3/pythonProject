...
coordinates = np.array([
    [33.00691,106.943519],#配送点
    [32.853819, 107.11977], [32.855425, 107.02023], [32.476447, 107.24196], [32.896059, 106.851525], [32.862359, 106.920404]
])
# 初始化距离矩阵
...
values = [0, 1.12,0.76,0.36,2.07,1.66]
...
sub = np.array([0,0,0,0,0])  # 自变量下限
up = np.array([4,3,2,1,0])  # 自变量上限
type = np.array([0,0,0,0,0])    #-1是有理数，0是整数，1是0-1变量
