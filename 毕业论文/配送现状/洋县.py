...
coordinates = np.array([
    [33.23089,107.551097],#配送点
    #[33.191308, 107.379953], [33.185724, 107.522117], [33.295333, 107.597683], [33.301104, 107.643113], [33.229662, 107.5166], [33.321278, 107.509222]
    [33.188826, 107.616218], [33.247487, 107.715211], [33.106391, 107.707625], [33.202029, 108.01222]
])
# 初始化距离矩阵
...
#values = [0, 1.3,3.48,0.7,0.81,2.15,0.46]
values = [0, 1.46,1.89,1.03,0.62]
...
sub = np.array([0,0,0,0])  # 自变量下限
up = np.array([3,2,1,0])  # 自变量上限
type = np.array([0,0,0,0])    #-1是有理数，0是整数，1是0-1变量
